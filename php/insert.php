<?php
  ...
  $query = mysqli_query($conn, "INSERT INTO queuemanagementsystem (Id, QueueNumber, TimeAdded, TimeComplete, Status, Complete, StoreId, New) VALUES ('', ".$queueNumber.", now(), null, 'False', 'False', ".$storeId.", 'True')"); //SQL Query
  $data;
  if($query)
  {
