  ...
  $.ajax
  	   ({
  		  ...
  		  success:function(response) {
  			...
  			{
  				$('#queueBox').append('<div id="div'+ response[i].queueNumber +'">' + response[i].queueNumber +  ' <img src="images/recall_btn.png" height="12%" width="12%" id="recallBtn" onclick="recallNumber('+response[i].queueNumber+')"/></button>' + ' ' + '<img src="images/complete_btn.png" height="12%" width="12%" id="deleteBtn" onclick="deleteQueueNumber('+response[i].queueNumber+')"/></div>');
  			}
  	    }
  	 });
